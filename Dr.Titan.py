...
def south():
    n=int(input(Fore.RED+"Enter 1 for Oncology(Cancer Related) Hospitals \n"
                ...
                "Enter 3 for Orthopaedic(Bones and Muscles Related) Hospitals\n"
...
def north():
    ...
    if n==1:
        ...
        print(Fore.YELLOW+"Orthopaedic(Bones and Muscles Related) Hospitals in North Bangalore : \n"
...
def east():
    ...
    if n==1:
        ...
        print(Fore.YELLOW+"Orthopaedic(Bones and Muscles Related) Hospitals in East Bangalore : \n"
              "1. Bowring and Lady Curzon Hospital, Shivaji Nagar, Contact Number : 08022156947\n"
...
def west():
    ...
    if n==1:
        ...
        print(Fore.YELLOW+"Orthopaedic(Bones and Muscles Related) Hospitals in West Bangalore : \n"
              "1. Abhilash Orthopaedic Hospital, Mahalakshmi Layout, Contact Number : 08022156947\n"
              "2. Sumeru Orthopaedic and Spine Hospital, Rajarajeshwari Nagar, Contact number : 08023530333\n")
    elif n==4:
...
def rural():
    ...
    if n==1:
        ...
        print(Fore.YELLOW+"Orthopaedic(Bones and Muscles Related) Hospitals in Rural Bangalore : \n"
              "1. Anand Orthopaedic and Knee Clinic, Hoskote, Contact Number : 08022556947\n"
...
def central():
    ...
    if n==1:
        ...
        print(Fore.YELLOW+"Orthopaedic(Bones and Muscles Related) Hospitals in Central Bangalore : \n"
              "1. Amrutha Orthopaedic and Knee Clinic, Indiranagar, Contact Number : 08022156947\n"
...
def toothache(age):
    if age>12:
        ...
        if n=='A'or n=='a':
            print("We will be redirecting you to our list of hospitals.Please enter 5 for nearest Dental Clinics near you : ")
            hospital(address)
        else:
...
def fever(age):
    y = "yes"
    ndays = int(input(Fore.MAGENTA+"How many days have you been facing this symptom\n"))
    temp = float(input(Fore.MAGENTA+"Enter the current temperature of your body in degree Fahrenheit\n"))
    if age < 12:
        if temp > 102.2:
            print(Fore.MAGENTA+"Please consult a doctor immediately")
            print(Fore.MAGENTA+"We will be redirecting you to our list of hospitals.Please enter 6 for nearest General Hospitals near you : ")
            hospital(address)
        else:
            if ndays < 4:
                print(Fore.GREEN+"No need to worry.Some of the home remedies you can try are:\n"
                      "1)Sit in a bath of lukewarm water\n"
                      "2)Wear light clothing\n"
                      "3)Drink cool or room temperature water")
            else:
                print(Fore.GREEN+"Suggested medications are:\n"
                      "1)Tylenol\n"
                      "2)Advil\n"
                      "3)Motrin\n")
                doc = input(Fore.MAGENTA+"Do you want to consult the doctor instead? Yes/No\n")
        ...
        if temp > 102.2:
            ...
            cov = input(Fore.MAGENTA+"Have u ever been in contact with a COVID-19 patient? Yes/No\n")
            if cov.casefold() == y.casefold():
                diag = input(Fore.MAGENTA+"Have you ever been diagnosed with a condition before? Yes/No\n")
                if diag.casefold() == y.casefold():
                    print(Fore.MAGENTA+"Please consult a doctor immediately")
                    print(Fore.MAGENTA+"We will be redirecting you to our list of hospitals.Please enter 6 for nearest General Hospitals near you : ")
                    hospital(address)
                else:
                    print(Fore.GREEN+"Please get yourself tested at a nearest COVID-19 test centre and Quarantine yourself for at least 4 days")
            else:
                if ndays < 4:
                    print(Fore.GREEN+"Some of the home remedies you can try are:\n"
                          "1)Sit in a bath of lukewarm water\n"
                          "2)Wear light clothing\n"
                          "3)Drink cool or room temperature water")
                else:
                    print(Fore.GREEN+"Suggested medications are:\n"
                          ...
                          "2)Acetaminophen\n"
                          "3)Naproxen\n")
                    doc1 = input(Fore.MAGENTA+"Do you want to consult the doctor instead? Yes/No\n")
...
def cough_throatpain(age):
    ...
    if age <= 2:
        ...
        print(Fore.GREEN+"If the cough or throat pain has been existent for more than 3 weeks please consult doctor immediately\n")
        print(Fore.GREEN+"Usually you can let the child recover on his/her own as it it's building their immunity towards it\n")
        print(Fore.GREEN+"The following medications might help:\n"
              "1)Dolo syrup\n"
              "2)Dolopar syrup")
    elif 13 < age < 45:
        cov = input(Fore.MAGENTA+"Have u ever been in contact with a COVID-19 patient? Yes/No\n")
        if cov.casefold() == y.casefold():
            ...
            if diag.casefold() == y.casefold():
                ...
                print(Fore.RED+"Please get yourself tested at a nearest COVID-19 test centre and Quarantine yourself for at least 4 days")
        else:
            print(Fore.GREEN+"Try some home remedies like:\n"
                  "1)Honey Tea\n"
                  "2)Ginger\n"
        ...
        print(Fore.MAGENTA+"Please consult doctor immediately with preferably a COVID-19 report")
        print(Fore.MAGENTA+"We will be redirecting you to our list of hospitals.Please enter 6 for nearest General Hospitals near you : ")
        hospital(address)
